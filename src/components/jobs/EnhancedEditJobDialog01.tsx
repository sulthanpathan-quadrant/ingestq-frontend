...
//       const fixedSteps = availableSteps
...
//       const usedSteps = Object.entries(job.steps)
...
//       const mergedStages = [
//         fixedSteps.find(fs => fs.type === 'upload_center')!, // First
//         ...usedSteps, // Used steps
//         fixedSteps.find(fs => fs.type === 'loading')!, // After used steps
//         fixedSteps.find(fs => fs.type === 'transfer')!, // Last
//       ].filter(Boolean);
