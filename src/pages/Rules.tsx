...
export default function Rules() {
  ...
  const failureAnalysis: FailureAnalysis[] = validationResponse?.issues
            ...
            {analysisStatus === 'success' && (
              <div className="space-y-4">
                <div className="text-center mb-6">
                  ...
                  <h3 className="text-lg font-semibold">Analysis Complete</h3>
                  <p className="text-sm text-muted-foreground">Found {failureAnalysis.length} issues that can be automatically resolved</p>
                </div>
                <div className="space-y-4 max-h-96 overflow-y-auto">
            ...
            {quickFixStatus === 'running' && (
              <div className="space-y-4">
                <div className="text-center">
                  ...
                  <p className="text-lg font-medium">Applying Quick Fixes...</p>
                  <p className="text-sm text-muted-foreground">
                    Resolving {failureAnalysis.length} identified issues
                  </p>
                </div>
                <Progress value={quickFixProgress} className="w-full" />
                <p className="text-center text-sm text-muted-foreground">
            ...
            {quickFixStatus === 'success' && (
              <div className="text-center space-y-4">
                ...
                <Button
                  onClick={() => {
                    setShowQuickFixDialog(false);
                    setValidationResults(prev => prev ? { ...prev, failed: 0, passed: smartRules.length + userRules.length, summary: `Validation completed: ${smartRules.length + userRules.length} rules passed, 0 rules failed. Data quality score: 100%` } : null);
                  }}
                  className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white"
                >
                  Continue
