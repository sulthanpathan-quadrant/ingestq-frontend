...
//   if (!bucket || !file) {
//     toast({ title: "Error", description: "Please select a bucket and file before proceeding", variant: "destructive" });
//     return;
//   }
//   if ((selectedDestination === "s3" || selectedDestination === "azure-blob") && !localStorage.getItem("selectedDestBucket")) {
//     toast({ title: "Error", description: "Destination bucket not properly set. Please reselect the destination.", variant: "destructive" });
...
//   // const handleGoBack = () => {
//   //   localStorage.setItem("returningFromUpload", "true");
//   //   navigate("/dashboard/jobs");
//   // };

//   const handleGoBack = () => {
//   // Set a flag to indicate return from Upload
//   localStorage.setItem("returningFromUpload", "true");
//   navigate("/dashboard/jobs");
// };
...
export default function Upload() {
  ...
  // Clear localStorage and reset state on component mount to prevent stale data
  useEffect(() => {
    localStorage.removeItem("selectedBucket");
    localStorage.removeItem("selectedFile");
    localStorage.removeItem("selectedDestFolder");
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-2">
                <Checkbox
                  ...
                  checked={selectAllTables}
                  onCheckedChange={(checked) => {
                    setSelectAllTables(checked as boolean);
                    if (checked) {
