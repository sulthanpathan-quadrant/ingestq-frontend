  ...
  return;
    ...
    try {
      ...
      toast({
        ...
        description: `Welcome to Veritas, ${registerData.username}!`,
      });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-accent/20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div className="space-y-8">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Veritas is an innovative AI-powered data ingestion platform that uses autonomous agents to intelligently process, validate, and transform your data. Our agentic approach means the system learns, adapts, and optimizes itself without constant human intervention.
              </p>
      ...
      <section id="about" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-muted/30 via-muted/20 to-accent/20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-4">About Veritas</h2>
            ...
            <div className="space-y-8">
              <div className="space-y-6 text-muted-foreground">
                <p className="text-lg leading-relaxed">
                  Veritas represents the next generation of data ingestion technology, built 
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-primary/5 via-primary/10 to-primary/5">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
            ...
            exploring AI-driven automation — Veritas provides the intelligence and flexibility 
      ...
      <Dialog open={showLogin} onOpenChange={setShowLogin}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="text-xl font-semibold">Login to Veritas</DialogTitle>
            <DialogDescription>
      ...
      <Dialog open={showRegister} onOpenChange={setShowRegister}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Sign up for your Veritas account
            </DialogDescription>
          </DialogHeader>
